...
def analyze_prompt_length(model, all_graphs, sentence_tokens: list, layers: int, k_top: int, T: int = None):
    ...
    #data1 = [
    #    [
    #        ([sublist[0]] + sublist[:-1]) if sublist else []
    #        for sublist in layer_list
    #    ]
    ...
    for length in range(2, max_length + 1):
        analyze_trajectory_origins(data[length], sentence_tokens, list(range(12)), k_top, save_dir = "att_exp/evolution1", None, length)
